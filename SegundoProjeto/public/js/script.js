...
function iniciar(){
    if(acao.value == 0){
        document.getElementById('erro_acao').innerHTML = "adiciona os minutos"
        acao.focus()
    }else if (pausa.value == 0){
        document.getElementById('erro_pausa').innerHTML = "adiciona intervalo"
        pausa.focus()
    }else if (sessoes.value == 0){
        document.getElementById('erro_sessoes').innerHTML = "adiciona as sessões"
        sessoes.focus()
    } else{
        lofi.play()
        pause.style.setProperty('display', 'block', 'important')
...
function momentoAcao (){
    ...
    if(sessoes_valor != '1'){
        ...
        document.getElementById('title_sessao').innerHTML = sessoes_valor + ' sessao restante '
    }
    ...
    title.style.setProperty( 'color', '#DF3414', 'important')
...
function momentoAcao() {
   ...
   // Função que será executada de 1 em 1 segundo
   function segTimer() {
